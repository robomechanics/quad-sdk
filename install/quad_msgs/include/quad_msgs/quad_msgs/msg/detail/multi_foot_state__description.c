...
static char quad_msgs__msg__MultiFootState__FIELD_NAME__header[] = "header";
static char quad_msgs__msg__MultiFootState__FIELD_NAME__traj_index[] = "traj_index";
static char quad_msgs__msg__MultiFootState__FIELD_NAME__feet[] = "feet";

static rosidl_runtime_c__type_description__Field quad_msgs__msg__MultiFootState__FIELDS[] = {
  {
    {quad_msgs__msg__MultiFootState__FIELD_NAME__header, 6, 6},
    {
  ...
  {
    {quad_msgs__msg__MultiFootState__FIELD_NAME__traj_index, 10, 10},
    {
  ...
  {
    {quad_msgs__msg__MultiFootState__FIELD_NAME__feet, 4, 4},
    {
...
static rosidl_runtime_c__type_description__IndividualTypeDescription quad_msgs__msg__MultiFootState__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      ...
      {quad_msgs__msg__MultiFootState__FIELDS, 3, 3},
    },
    {quad_msgs__msg__MultiFootState__REFERENCED_TYPE_DESCRIPTIONS, 4, 4},
  };
  if (!constructed) {
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *quad_msgs__msg__MultiFootState__get_individual_type_description_source(NULL),
