...
void CompFilterEstimator::init(ros::NodeHandle nh) {
  ...
  quad_utils::loadROSParam(nh, "robot_driver/high_pass_a", high_pass_a_);
  quad_utils::loadROSParam(nh, "robot_driver/high_pass_b", high_pass_b_);
  quad_utils::loadROSParam(nh, "robot_driver/high_pass_c", high_pass_c_);
  quad_utils::loadROSParam(nh, "robot_driver/high_pass_d", high_pass_d_);

  quad_utils::loadROSParam(nh, "robot_driver/low_pass_a", low_pass_a_);
  quad_utils::loadROSParam(nh, "robot_driver/low_pass_b", low_pass_b_);
  quad_utils::loadROSParam(nh, "robot_driver/low_pass_c", low_pass_c_);
  quad_utils::loadROSParam(nh, "robot_driver/low_pass_d", low_pass_d_);
  high_pass_filter.A =
