#ifndef MJCF_TO_GRID_MAP_CONVERTER_H
#define MJCF_TO_GRID_MAP_CONVERTER_H
...
static const std::string kDefaultWorldName = "terrain";

class MjcfToGridMapConverter {
 public:
  MjcfToGridMapConverter(rclcpp::Node::SharedPtr node);
