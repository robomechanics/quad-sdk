...
TEST(NMPCTest, testUtils) {
  ...
  // std::cout << "nlp.n_constraints_ target = " << (g + 2 * n) * N <<
  // std::endl; std::cout << "nlp.complexity_schedule_ = "
  ...
  //           << std::endl;
  // std::cout << "nlp.iRow_jac_g_.sum() = " << nlp.iRow_jac_g_.sum() <<
  // std::endl; std::cout << "nlp.jCol_jac_g_.sum() = " << nlp.jCol_jac_g_.sum()
  // << std::endl; std::cout << "nlp.nnz_h_ = " << nlp.nnz_h_ << std::endl;
  ...
  // std::cout << "\ncomplexity_schedule = 1" << std::endl;
  // std::cout << "nlp.complexity_schedule_ = "
  //           << nlp.complexity_schedule_.transpose() << std::endl;
  // std::cout << "nlp.sys_id_schedule_ = " << nlp.sys_id_schedule_.transpose()
  //           << std::endl;
