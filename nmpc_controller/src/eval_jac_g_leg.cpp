...
static const casadi_int casadi_s2[200] = {
    ...
    0,   1,   2,   3,   4,   5,   10,  11,  3,   4,   5,   9,   11,  5,   9,
    10,  6,   7,   8,   3,   9,   10,  11,  3,   4,   5,   9,   10,  11,  3,
    4,   5,   9,   10,  11};
...
extern "C" CASADI_SYMBOL_EXPORT int eval_jac_g_leg(const casadi_real** arg,
                                                   casadi_real** res,
                                                   casadi_int* iw,
                                                   casadi_real* w, int mem) {
...
extern "C" CASADI_SYMBOL_EXPORT int eval_jac_g_leg_alloc_mem(void) { return 0; }
...
extern "C" CASADI_SYMBOL_EXPORT int eval_jac_g_leg_checkout(void) { return 0; }
...
extern "C" CASADI_SYMBOL_EXPORT casadi_int eval_jac_g_leg_n_in(void) {
  return 2;
}

extern "C" CASADI_SYMBOL_EXPORT casadi_int eval_jac_g_leg_n_out(void) {
  return 1;
}

extern "C" CASADI_SYMBOL_EXPORT casadi_real
eval_jac_g_leg_default_in(casadi_int i) {
  switch (i) {
    default:
      return 0;
  }
...
extern "C" CASADI_SYMBOL_EXPORT const char* eval_jac_g_leg_name_in(
    casadi_int i) {
  switch (i) {
    case 0:
      return "w";
...
extern "C" CASADI_SYMBOL_EXPORT const char* eval_jac_g_leg_name_out(
    casadi_int i) {
  switch (i) {
    case 0:
      return "jac_g";
...
extern "C" CASADI_SYMBOL_EXPORT const casadi_int* eval_jac_g_leg_sparsity_in(
    casadi_int i) {
  switch (i) {
    case 0:
      return casadi_s0;
...
extern "C" CASADI_SYMBOL_EXPORT const casadi_int* eval_jac_g_leg_sparsity_out(
    casadi_int i) {
  switch (i) {
    case 0:
      return casadi_s2;
...
extern "C" CASADI_SYMBOL_EXPORT int eval_jac_g_leg_work(casadi_int* sz_arg,
                                                        casadi_int* sz_res,
                                                        casadi_int* sz_iw,
                                                        casadi_int* sz_w) {
  if (sz_arg) *sz_arg = 2;
