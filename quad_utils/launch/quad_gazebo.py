...
def generate_launch_description():
    declared_args = [
        DeclareLaunchArgument('world', default_value='beam_15cm.sdf', description='SDF world file name to load into simulation'),
        ...
        DeclareLaunchArgument(
            'robot_configs', default_value=('[{"name": "robot_1", "type": "go2", "controller": "beamwalking", "init_pose": "-x 0.0 -y 0.0 -z 3.0"}]'),
        ...
        DeclareLaunchArgument('scenario', default_value="flat", description='Custom Obstacle Scenario to Spawn e.g. Underbrush, Procedural Underbrush)'),
