...
void interpRobotPlan(quad_msgs::RobotPlan msg, double t,
  ...
  quad_msgs::RobotState state_1, state_2;
  int primitive_id_1, primitive_id_2;
  quad_msgs::GRFArray grf_1, grf_2;
...
quad_msgs::MultiFootState interpMultiFootPlanContinuous(
  ...
  // Declare variables for interpolating between, both for input and output data
  quad_msgs::MultiFootState state_1, state_2, interp_state;
...
void vector3MsgToEigen(const geometry_msgs::Vector3 &vec,
...
=======
  ...
  void interpMultiFootState(quad_msgs::MultiFootState state_1,
    quad_msgs::MultiFootState state_2, double t_interp, quad_msgs::MultiFootState &interp_state) {
  ...
  void interpGRFArray(quad_msgs::GRFArray state_1,
    quad_msgs::GRFArray state_2, double t_interp, quad_msgs::GRFArray &interp_state) {
  ...
  void interpRobotState(quad_msgs::RobotState state_1,
    quad_msgs::RobotState state_2, double t_interp, quad_msgs::RobotState &interp_state) {
  ...
  void ikRobotState(const quad_utils::QuadKD &kinematics,
    ...
    // Compute joint velocities
    joint_velocities = math_utils::sdlsInv(jacobian.leftCols(12)) *
                       (ref_foot_velocities -
                        jacobian.rightCols(6) * ref_body_state.tail(6));
  ...
  void multiFootStateMsgToEigen(const quad_msgs::MultiFootState &multi_foot_state_msg, Eigen::VectorXd &foot_positions,
  ...
  void eigenToFootStateMsg(Eigen::VectorXd foot_positions, Eigen::VectorXd foot_velocities,
                           Eigen::VectorXd foot_acceleration, quad_msgs::FootState &foot_state_msg)
  {
    eigenToFootStateMsg(foot_positions, foot_velocities, foot_state_msg);
  ...
  void eigenToFootStateMsg(Eigen::VectorXd foot_positions, 
    Eigen::VectorXd foot_velocities, quad_msgs::FootState &foot_state_msg) {
