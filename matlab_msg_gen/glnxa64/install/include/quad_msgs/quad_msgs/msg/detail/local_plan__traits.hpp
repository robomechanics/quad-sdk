...
#ifndef QUAD_MSGS__MSG__DETAIL__LOCAL_PLAN__TRAITS_HPP_
#define QUAD_MSGS__MSG__DETAIL__LOCAL_PLAN__TRAITS_HPP_
...
inline std::string to_yaml(const LocalPlan & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const quad_msgs::msg::LocalPlan & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const quad_msgs::msg::LocalPlan & msg)
{
  return quad_msgs::msg::to_yaml(msg);
}

template<>
inline const char * data_type<quad_msgs::msg::LocalPlan>()
{
  return "quad_msgs::msg::LocalPlan";
}

template<>
inline const char * name<quad_msgs::msg::LocalPlan>()
{
  return "quad_msgs/msg/LocalPlan";
}

template<>
struct has_fixed_size<quad_msgs::msg::LocalPlan>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<quad_msgs::msg::LocalPlan>
  : std::integral_constant<bool, false> {};

template<>
struct is_message<quad_msgs::msg::LocalPlan>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // QUAD_MSGS__MSG__DETAIL__LOCAL_PLAN__TRAITS_HPP_
