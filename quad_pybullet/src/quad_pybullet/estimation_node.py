...
#  This is a very simple implementation that runs only one quadruped robot, with potentially extra joints.
    ...
    def __init__(self,node_name,robot_id, physicsClient_id, step_rate = 200,state_topic_name = None,grf_topic_name = None):
    ...
    def run(self):
        ...
        quad_pb_states = rospy.Publisher(self.state_topic_name,RobotState,queue_size=5)
        quad_pb_grfs = rospy.Publisher(self.grf_topic_name,GRFArray,queue_size=5)
