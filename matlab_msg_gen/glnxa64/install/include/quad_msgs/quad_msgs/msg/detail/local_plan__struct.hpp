...
#ifndef QUAD_MSGS__MSG__DETAIL__LOCAL_PLAN__STRUCT_HPP_
#define QUAD_MSGS__MSG__DETAIL__LOCAL_PLAN__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__quad_msgs__msg__LocalPlan __attribute__((deprecated))
#else
# define DEPRECATED__quad_msgs__msg__LocalPlan __declspec(deprecated)
#endif
...
struct LocalPlan_
{
  using Type = LocalPlan_<ContainerAllocator>;

  explicit LocalPlan_(rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  : header(_init),
  ...
  explicit LocalPlan_(const ContainerAllocator & _alloc, rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  : header(_alloc, _init),
  ...
  // pointer types
  using RawPtr =
    quad_msgs::msg::LocalPlan_<ContainerAllocator> *;
  using ConstRawPtr =
    const quad_msgs::msg::LocalPlan_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<quad_msgs::msg::LocalPlan_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<quad_msgs::msg::LocalPlan_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      quad_msgs::msg::LocalPlan_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<quad_msgs::msg::LocalPlan_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<quad_msgs::msg::LocalPlan_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<quad_msgs::msg::LocalPlan_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<quad_msgs::msg::LocalPlan_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__quad_msgs__msg__LocalPlan
    std::shared_ptr<quad_msgs::msg::LocalPlan_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__quad_msgs__msg__LocalPlan
    std::shared_ptr<quad_msgs::msg::LocalPlan_<ContainerAllocator> const>
  ...
  bool operator==(const LocalPlan_ & other) const
  {
...
using LocalPlan =
  quad_msgs::msg::LocalPlan_<std::allocator<void>>;
...
#endif  // QUAD_MSGS__MSG__DETAIL__LOCAL_PLAN__STRUCT_HPP_
