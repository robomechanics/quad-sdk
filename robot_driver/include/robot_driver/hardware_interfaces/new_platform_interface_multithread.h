#ifndef NEW_PLATFORM_INTERFACE_MULTITHREAD_H
#define NEW_PLATFORM_INTERFACE_MULTITHREAD_H
...
*/
class NewPlatformInterfaceMultithread : public HardwareInterface 
{
 public:
  /**
   ...
   */
  NewPlatformInterfaceMultithread();
...
#endif  // NEW_PLATFORM_INTERFACE_MULTITHREAD_H
