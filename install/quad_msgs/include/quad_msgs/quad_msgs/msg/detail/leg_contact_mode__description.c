...
static char quad_msgs__msg__LegContactMode__FIELD_NAME__header[] = "header";
static char quad_msgs__msg__LegContactMode__FIELD_NAME__contact_prob[] = "contact_prob";
static char quad_msgs__msg__LegContactMode__FIELD_NAME__contact_state[] = "contact_state";
static char quad_msgs__msg__LegContactMode__FIELD_NAME__contact_forces[] = "contact_forces";

static rosidl_runtime_c__type_description__Field quad_msgs__msg__LegContactMode__FIELDS[] = {
  {
    {quad_msgs__msg__LegContactMode__FIELD_NAME__header, 6, 6},
    {
  ...
  {
    {quad_msgs__msg__LegContactMode__FIELD_NAME__contact_prob, 12, 12},
    {
  ...
  {
    {quad_msgs__msg__LegContactMode__FIELD_NAME__contact_state, 13, 13},
    {
  ...
  {
    {quad_msgs__msg__LegContactMode__FIELD_NAME__contact_forces, 14, 14},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
...
static rosidl_runtime_c__type_description__IndividualTypeDescription quad_msgs__msg__LegContactMode__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      ...
      {quad_msgs__msg__LegContactMode__FIELDS, 4, 4},
    },
    {quad_msgs__msg__LegContactMode__REFERENCED_TYPE_DESCRIPTIONS, 3, 3},
  };
  if (!constructed) {
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *quad_msgs__msg__LegContactMode__get_individual_type_description_source(NULL),
