...
#  This is a very simple implementation that runs only one quadruped robot, with potentially extra joints.
    ...
    def __init__(self,node_name,robot_id,pybullet_client_id,sub_name = None,step_rate = 200):
        ...
        self.driver = Robot_pydriver(self.robot_id,self.pcid,torque_control=False)
