...
static char quad_msgs__msg__FootPlanDiscrete__FIELD_NAME__header[] = "header";
static char quad_msgs__msg__FootPlanDiscrete__FIELD_NAME__footholds[] = "footholds";

static rosidl_runtime_c__type_description__Field quad_msgs__msg__FootPlanDiscrete__FIELDS[] = {
  {
    {quad_msgs__msg__FootPlanDiscrete__FIELD_NAME__header, 6, 6},
    {
  ...
  {
    {quad_msgs__msg__FootPlanDiscrete__FIELD_NAME__footholds, 9, 9},
    {
...
static rosidl_runtime_c__type_description__IndividualTypeDescription quad_msgs__msg__FootPlanDiscrete__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      ...
      {quad_msgs__msg__FootPlanDiscrete__FIELDS, 2, 2},
    },
    {quad_msgs__msg__FootPlanDiscrete__REFERENCED_TYPE_DESCRIPTIONS, 4, 4},
  };
  if (!constructed) {
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *quad_msgs__msg__FootPlanDiscrete__get_individual_type_description_source(NULL),
