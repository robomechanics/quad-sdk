...
#ifndef QUAD_MSGS__MSG__DETAIL__ROBOT_PLAN__TYPE_SUPPORT_H_
#define QUAD_MSGS__MSG__DETAIL__ROBOT_PLAN__TYPE_SUPPORT_H_
...
#endif  // QUAD_MSGS__MSG__DETAIL__ROBOT_PLAN__TYPE_SUPPORT_H_
