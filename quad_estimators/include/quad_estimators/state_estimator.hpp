#ifndef QUAD_ESTIMATORS_STATE_ESTIMATOR_H
#define QUAD_ESTIMATORS_STATE_ESTIMATOR_H
...
/*!
   ...
   Ported out of robot_driver into standalone quad_estimators (math identical).
*/
...
#endif  // QUAD_ESTIMATORS_STATE_ESTIMATOR_H
