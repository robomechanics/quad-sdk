...
quad_msgs::RobotState EKFEstimator::StepOnce() {
  ...
  /// Update Step
  this->update(jk, vk, wk); // Uncomment for Update Step
...
void EKFEstimator::update(const Eigen::VectorXd& jk, const Eigen::VectorXd& vk, const Eigen::VectorXd& wk) {
