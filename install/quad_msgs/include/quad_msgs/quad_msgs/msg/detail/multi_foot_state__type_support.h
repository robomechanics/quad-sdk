...
#ifndef QUAD_MSGS__MSG__DETAIL__MULTI_FOOT_STATE__TYPE_SUPPORT_H_
#define QUAD_MSGS__MSG__DETAIL__MULTI_FOOT_STATE__TYPE_SUPPORT_H_
...
#endif  // QUAD_MSGS__MSG__DETAIL__MULTI_FOOT_STATE__TYPE_SUPPORT_H_
