...
namespace spirit_utils {
  ...
  void getFootJacobian(int leg_idx,
    ...
    {
    case 0:
      getFootJacobian0(state, foot_jacobian);
      break;
    case 1:
      getFootJacobian1(state, foot_jacobian);
      break;
    case 2:
      getFootJacobian2(state, foot_jacobian);
      break;
    case 3:
      getFootJacobian3(state, foot_jacobian);
      break;
  ...
  void getFootJacobian0(const Eigen::VectorXd &state, Eigen::MatrixXd& foot_jacobian0)
  {
    ...
    spirit_utils::eigenToVector(state, in1);
    ...
    // foot_jacobian0 = Eigen::Map<Eigen::MatrixXd>(J0,3,3);
  ...
  void getFootJacobian1(const Eigen::VectorXd &state, Eigen::MatrixXd& foot_jacobian1)
  {
    ...
    J1[8] = (t35 * t54 + t52 * t56) - t22 * t55;
      // Map the array to the matrix
    // foot_jacobian1 = Eigen::Map<Eigen::MatrixXd>(J1,3,3);
  ...
  void getFootJacobian2(const Eigen::VectorXd &state, Eigen::MatrixXd& foot_jacobian2)
  {
    ...
    J2[8] = (t35 * t54 + t52 * t56) - t22 * t55;
      // Map the array to the matrix
    // foot_jacobian2 = Eigen::Map<Eigen::MatrixXd>(J2,3,3);
  ...
  void getFootJacobian3(const Eigen::VectorXd &state, Eigen::MatrixXd& foot_jacobian3)
  {
    ...
    J3[8] = (t35 * t54 + t52 * t56) - t22 * t55;
        // Map the array to the matrix
    // foot_jacobian3 = Eigen::Map<Eigen::MatrixXd>(J3,3,3);
  ...
  void getJacobian(const Eigen::VectorXd &state, Eigen::MatrixXd& jacobian)
  {
    ...
    // Map the array to the matrix
    // jacobian = Eigen::Map<Eigen::MatrixXd>(A,12,18);
