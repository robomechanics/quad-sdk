...
class GlobalBodyPlan {
 public:
   ...
   */
  inline void setPublishedTimestamp(rclcpp::Time timestamp) {
  ...
  void addStateAndGRFToMsg(double t, int plan_index,
                           ...
                           int primitive_id, quad_msgs::msg::RobotPlan& msg);
   ...
   */
  void convertToMsg(quad_msgs::msg::RobotPlan& robot_plan_msg,
