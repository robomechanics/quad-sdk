...
[:material-file-pdf-box: Open the paper](https://www.andrew.cmu.edu/user/amj1/papers/Quad_SDK_ICRA_Abstract.pdf){ .md-button }

## The Global Body Planner (GBP-L)

Cite this if you use the [Global Body Planner](packages/global_body_planner.md):
...
[:material-file-pdf-box: Open the paper](https://www.andrew.cmu.edu/user/amj1/papers/IROS2023_Proprioception_and_Reaction_for_Walking_Among_Entanglements.pdf){ .md-button }
...
> This work builds on [Quad-SDK](https://github.com/robomechanics/quad-sdk), an open-source framework for quadrupedal locomotion developed at the Robomechanics Lab, Carnegie Mellon University.
