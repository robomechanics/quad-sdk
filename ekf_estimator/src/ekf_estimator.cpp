...
quad_msgs::RobotState EKFEstimator::updateStep() {
  ...
  if (last_joint_state_msg_ != NULL) {
    ...
    joints_data = {0.767431,  1.591838,  0.804742, 1.612967,
                   0.721895,  1.562485,  0.729919, 1.514980,
                   -0.012140, -0.024205, 0.050132, 0.058434};
  }
  ...
  imu_bias << bias_x_, bias_y_, bias_z_;
  ...
  if (last_state_msg_ != NULL) {
    ...
    x << -1.457778, 1.004244, 0.308681, 0, 0, 0;
    last_x = x;
  }
...
void EKFEstimator::spin() {
  ...
  x0 << -1.457778, 1.004244, 0.308681, 0, 0, 0;
  x = x0;
  last_x = x;
