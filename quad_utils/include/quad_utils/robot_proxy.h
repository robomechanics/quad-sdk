...
//! A class for interfacing between dummy robot data and other quad-software nodes and topics.
/*!
   RobotProxy contains the approximation for the real quad robot. Its purposes are purely for development.
