#ifndef LOCAL_BODY_PLANNER_H
#define LOCAL_BODY_PLANNER_H
...
*/
class LocalBodyPlanner {
  public:
	/**
	 * @brief Constructor for LocalBodyPlanner
	 * @param[in] nh ROS NodeHandle to publish and subscribe from
	 * @return Constructed object of type LocalBodyPlanner
	 */
	LocalBodyPlanner(ros::NodeHandle nh);
