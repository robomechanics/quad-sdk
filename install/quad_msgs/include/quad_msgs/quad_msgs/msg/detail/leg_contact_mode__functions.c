...
quad_msgs__msg__LegContactMode__init(quad_msgs__msg__LegContactMode * msg)
{
  ...
  if (!std_msgs__msg__Header__init(&msg->header)) {
    quad_msgs__msg__LegContactMode__fini(msg);
    return false;
  }
  // contact_prob
  // contact_state
  // contact_forces
  if (!geometry_msgs__msg__Vector3__init(&msg->contact_forces)) {
    quad_msgs__msg__LegContactMode__fini(msg);
    return false;
  }
  return true;
...
quad_msgs__msg__LegContactMode__fini(quad_msgs__msg__LegContactMode * msg)
{
  ...
  // contact_state
  // contact_forces
  geometry_msgs__msg__Vector3__fini(&msg->contact_forces);
}
...
quad_msgs__msg__LegContactMode__are_equal(const quad_msgs__msg__LegContactMode * lhs, const quad_msgs__msg__LegContactMode * rhs)
{
  ...
  // contact_prob
  if (lhs->contact_prob != rhs->contact_prob) {
    return false;
  }
  // contact_state
  if (lhs->contact_state != rhs->contact_state) {
    return false;
  }
  // contact_forces
  ...
  quad_msgs__msg__LegContactMode * output)
{
  ...
  // contact_prob
  output->contact_prob = input->contact_prob;
  // contact_state
...
quad_msgs__msg__LegContactMode__create(void)
{
  ...
  quad_msgs__msg__LegContactMode * msg = (quad_msgs__msg__LegContactMode *)allocator.allocate(sizeof(quad_msgs__msg__LegContactMode), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(quad_msgs__msg__LegContactMode));
  bool success = quad_msgs__msg__LegContactMode__init(msg);
  if (!success) {
...
quad_msgs__msg__LegContactMode__Sequence__init(quad_msgs__msg__LegContactMode__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  quad_msgs__msg__LegContactMode * data = NULL;

  if (size) {
    data = (quad_msgs__msg__LegContactMode *)allocator.zero_allocate(size, sizeof(quad_msgs__msg__LegContactMode), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = quad_msgs__msg__LegContactMode__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        quad_msgs__msg__LegContactMode__fini(&data[i - 1]);
      }
...
quad_msgs__msg__LegContactMode__Sequence__fini(quad_msgs__msg__LegContactMode__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      quad_msgs__msg__LegContactMode__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  quad_msgs__msg__LegContactMode__Sequence * array = (quad_msgs__msg__LegContactMode__Sequence *)allocator.allocate(sizeof(quad_msgs__msg__LegContactMode__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = quad_msgs__msg__LegContactMode__Sequence__init(array, size);
  if (!success) {
...
quad_msgs__msg__LegContactMode__Sequence__destroy(quad_msgs__msg__LegContactMode__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    quad_msgs__msg__LegContactMode__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
quad_msgs__msg__LegContactMode__Sequence__are_equal(const quad_msgs__msg__LegContactMode__Sequence * lhs, const quad_msgs__msg__LegContactMode__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!quad_msgs__msg__LegContactMode__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  quad_msgs__msg__LegContactMode__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(quad_msgs__msg__LegContactMode);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    quad_msgs__msg__LegContactMode * data =
      (quad_msgs__msg__LegContactMode *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!quad_msgs__msg__LegContactMode__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          quad_msgs__msg__LegContactMode__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!quad_msgs__msg__LegContactMode__copy(
