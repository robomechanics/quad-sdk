...
void WheeledGroundTruthEstimator::Configure(
...
void WheeledGroundTruthEstimator::PostUpdate(
...
GZ_ADD_PLUGIN(gz_plugins::WheeledGroundTruthEstimator, gz::sim::System,
              gz::sim::ISystemConfigure, gz::sim::ISystemPostUpdate)

GZ_ADD_PLUGIN_ALIAS(gz_plugins::WheeledGroundTruthEstimator, "wheeled_ground_truth_estimator")
