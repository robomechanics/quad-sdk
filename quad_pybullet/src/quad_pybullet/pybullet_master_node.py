...
#  This is a very simple implementation that runs only one quadruped robot, with potentially extra joints.
    ...
    def __init__(self,node_name,step_rate,robot_file,world_urdf = None,sub_name = None,pub_name = None,clock_topic = None,\
        load_sdf = False):
    ...
    def run(self):
        ...
        # self.clock_pub = rospy.Publisher(self.clock_topic,Clock,queue_size=5)
        ...
        startPos = [0,0,0.4]
        startOrientation = pb.getQuaternionFromEuler([3.14,0,0],physicsClientId = physicsClient)
        # If single robot:
        if self.use_sdf:
        ...
        # simthread = threading.Thread(target=self.sim_routine)
