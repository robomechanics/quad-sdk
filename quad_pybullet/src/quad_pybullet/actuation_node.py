...
#  This is a very simple implementation that runs only one quadruped robot, with potentially extra joints.
    ...
    def __init__(self,node_name,robot_id,pybullet_client_id,sub_name = None):
        ...
        self.subscriber_callback = self.driver.drive_all_legs # setup callback function when running
