...
ContactStatePublisher::ContactStatePublisher(ros::NodeHandle nh) : listener_(buffer_) {
  ...
  quad_utils::loadROSParam(nh_,"topics/gazebo/toe0_contact_state",toe0_contact_state_topic);
  quad_utils::loadROSParam(nh_,"topics/gazebo/toe1_contact_state",toe1_contact_state_topic);
  quad_utils::loadROSParam(nh_,"topics/gazebo/toe2_contact_state",toe2_contact_state_topic);
  quad_utils::loadROSParam(nh_,"topics/gazebo/toe3_contact_state",toe3_contact_state_topic);

  quad_utils::loadROSParam(nh_,"contact_state_publisher/update_rate", update_rate_);
