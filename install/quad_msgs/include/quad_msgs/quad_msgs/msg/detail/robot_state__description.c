...
static char quad_msgs__msg__RobotState__FIELD_NAME__header[] = "header";
static char quad_msgs__msg__RobotState__FIELD_NAME__traj_index[] = "traj_index";
static char quad_msgs__msg__RobotState__FIELD_NAME__body[] = "body";
static char quad_msgs__msg__RobotState__FIELD_NAME__joints[] = "joints";
static char quad_msgs__msg__RobotState__FIELD_NAME__feet[] = "feet";

static rosidl_runtime_c__type_description__Field quad_msgs__msg__RobotState__FIELDS[] = {
  {
    {quad_msgs__msg__RobotState__FIELD_NAME__header, 6, 6},
    {
  ...
  {
    {quad_msgs__msg__RobotState__FIELD_NAME__traj_index, 10, 10},
    {
  ...
  {
    {quad_msgs__msg__RobotState__FIELD_NAME__body, 4, 4},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
  ...
  {
    {quad_msgs__msg__RobotState__FIELD_NAME__joints, 6, 6},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
  ...
  {
    {quad_msgs__msg__RobotState__FIELD_NAME__feet, 4, 4},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
...
static rosidl_runtime_c__type_description__IndividualTypeDescription quad_msgs__msg__RobotState__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      ...
      {quad_msgs__msg__RobotState__FIELDS, 5, 5},
    },
    {quad_msgs__msg__RobotState__REFERENCED_TYPE_DESCRIPTIONS, 11, 11},
  };
  if (!constructed) {
    ...
    description.referenced_type_descriptions.data[8].fields = quad_msgs__msg__MultiFootState__get_type_description(NULL)->type_description.fields;
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *quad_msgs__msg__RobotState__get_individual_type_description_source(NULL),
    ...
    sources[9] = *quad_msgs__msg__MultiFootState__get_individual_type_description_source(NULL);
