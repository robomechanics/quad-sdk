#include "mujoco_ground_truth/mujoco_ground_truth_node.hpp"

#include <cmath>

using std::placeholders::_1;

MujocoGroundTruthNode::MujocoGroundTruthNode()
: Node("mujoco_ground_truth_node")
{
    ...
    odom_sub_ = this->create_subscription<nav_msgs::msg::Odometry>(
        "/robot_1/odom", 10,
        std::bind(&MujocoGroundTruthNode::odomCallback, this, _1));

    // Joint states subscriber — joint_state_broadcaster publishes RELIABLE + VOLATILE
    ...
    joint_sub_ = this->create_subscription<sensor_msgs::msg::JointState>(
        ...
        std::bind(&MujocoGroundTruthNode::jointCallback, this, _1));
    ...
    urdf_sub_ = this->create_subscription<std_msgs::msg::String>(
        ...
        [this](const std_msgs::msg::String::SharedPtr msg) {
            ...
            kd_node_ = std::make_shared<rclcpp::Node>(
                "mujoco_ground_truth_kd", opts);

            kd_node_->declare_parameter<std::string>("robot_description", msg->data);
    ...
    // Body-frame state — mirrors ground_truth_state_body_frame_pub_ in Gazebo plugin
    ...
    timer_ = this->create_wall_timer(
        ...
        std::bind(&MujocoGroundTruthNode::publishState, this));

    RCLCPP_INFO(this->get_logger(), "MuJoCo Ground Truth Bridge initialized");
}

void MujocoGroundTruthNode::odomCallback(
    const nav_msgs::msg::Odometry::SharedPtr msg)
{
    latest_odom_ = msg;
}

void MujocoGroundTruthNode::jointCallback(
...
std::array<double, 3>
MujocoGroundTruthNode::rotateWorldToBody(
...
std::array<double, 3>
MujocoGroundTruthNode::rotateBodyToWorld(
    double qw, double qx, double qy, double qz,
    double vx, double vy, double vz)
{
...
void MujocoGroundTruthNode::publishState()
{
    ...
    auto [vx_b, vy_b, vz_b] = rotateWorldToBody(qw, qx, qy, qz,
                                                  vx_w, vy_w, vz_w);
    ...
    auto [wx_w, wy_w, wz_w] = rotateBodyToWorld(qw, qx, qy, qz,
                                                  wx_b, wy_b, wz_b);
    ...
    for (int i = 0; i < 4; ++i) {
        ...
        auto [vfx, vfy, vfz] = rotateWorldToBody(qw, qx, qy, qz,
...
int main(int argc, char ** argv)
{
    ...
    auto node = std::make_shared<MujocoGroundTruthNode>();
    rclcpp::spin(node);
    rclcpp::shutdown();
    return 0;
}
