...
def generate_launch_description():
    return LaunchDescription([
        ...
        DeclareLaunchArgument('force_app', default_value='true', description='Launch Force Applicator Alongside Planning'),
        DeclareLaunchArgument(
            'robot_configs',
            default_value='[{"name": "robot_1", "type": "spirit", "controller_mode" : "inverse_dynamics", "reference": "gbpl", "twist_input": "None"}]',
