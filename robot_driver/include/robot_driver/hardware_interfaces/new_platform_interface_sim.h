#ifndef NEW_PLATFORM_INTERFACE_SIM_H
#define NEW_PLATFORM_INTERFACE_SIM_H
...
*/
class NewPlatformInterfaceSim : public HardwareInterface 
{
 public:
  /**
...
#endif  // NEW_PLATFORM_INTERFACE_SIM_H
