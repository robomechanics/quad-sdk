...
step_rate = 500
pybullet_pub_name = "/state/ground_truth_pb"
# pybullet_pub_name = "/state/ground_truth"
pybullet_pcid = 0
pybullet_robotid = 1

if __name__ == '__main__':
    new_node = pybullet_estimation_node(node_name,pybullet_robotid,pybullet_pcid,step_rate=200,pub_name = pybullet_pub_name)
