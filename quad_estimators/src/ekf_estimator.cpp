...
void EKFEstimator::init() {
  ...
  quad_utils::loadROSParam(node_, "update_rate", update_rate_);
  ...
  // Load initial IMU bias from estimator yaml
  quad_utils::loadROSParam(node_, "bias_x", bias_x_);
  quad_utils::loadROSParam(node_, "bias_y", bias_y_);
  quad_utils::loadROSParam(node_, "bias_z", bias_z_);
  quad_utils::loadROSParam(node_, "bias_r", bias_r_);
  quad_utils::loadROSParam(node_, "bias_p", bias_p_);
  quad_utils::loadROSParam(node_, "bias_w", bias_w_);

  // Load noise terms from estimator yaml
  quad_utils::loadROSParam(node_, "na", na_);
  quad_utils::loadROSParam(node_, "nv", nv_);
  quad_utils::loadROSParam(node_, "ng", ng_);
  quad_utils::loadROSParam(node_, "ba", ba_);
  quad_utils::loadROSParam(node_, "bg", bg_);
  quad_utils::loadROSParam(node_, "nf", nf_);
  quad_utils::loadROSParam(node_, "nfk", nfk_);
  quad_utils::loadROSParam(node_, "ne", ne_);
  quad_utils::loadROSParam(node_, "nfh", nfh_);
  quad_utils::loadROSParam(node_, "P0", P0_);
  quad_utils::loadROSParam(node_, "contact_w", contact_w_);
  quad_utils::loadROSParam(node_, "thresh_out", thresh_out);
  quad_utils::loadROSParam(node_, "foot_radius", foot_radius);
