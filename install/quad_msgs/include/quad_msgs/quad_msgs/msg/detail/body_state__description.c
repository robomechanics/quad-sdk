...
static char quad_msgs__msg__BodyState__FIELD_NAME__header[] = "header";
static char quad_msgs__msg__BodyState__FIELD_NAME__traj_index[] = "traj_index";
static char quad_msgs__msg__BodyState__FIELD_NAME__pose[] = "pose";
static char quad_msgs__msg__BodyState__FIELD_NAME__twist[] = "twist";

static rosidl_runtime_c__type_description__Field quad_msgs__msg__BodyState__FIELDS[] = {
  {
    {quad_msgs__msg__BodyState__FIELD_NAME__header, 6, 6},
    {
  ...
  {
    {quad_msgs__msg__BodyState__FIELD_NAME__traj_index, 10, 10},
    {
  ...
  {
    {quad_msgs__msg__BodyState__FIELD_NAME__pose, 4, 4},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
  ...
  {
    {quad_msgs__msg__BodyState__FIELD_NAME__twist, 5, 5},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
...
static rosidl_runtime_c__type_description__IndividualTypeDescription quad_msgs__msg__BodyState__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      ...
      {quad_msgs__msg__BodyState__FIELDS, 4, 4},
    },
    {quad_msgs__msg__BodyState__REFERENCED_TYPE_DESCRIPTIONS, 7, 7},
  };
  if (!constructed) {
...
quad_msgs__msg__BodyState__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *quad_msgs__msg__BodyState__get_individual_type_description_source(NULL),
