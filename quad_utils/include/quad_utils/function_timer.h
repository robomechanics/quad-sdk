...
class FunctionTimer {
  public:
    ...
    /**
     * @brief Report the averaged statistics to the terminal over a given number of iterations
     * @param[in] n Number of iterations executed during elapsed time (used for averaging)
     */
