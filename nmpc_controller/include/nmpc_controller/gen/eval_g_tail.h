...
extern "C" int eval_g_tail_checkout(void);
extern "C" void eval_g_tail_release(int mem);
extern "C" void eval_g_tail_incref(void);
extern "C" void eval_g_tail_decref(void);
extern "C" casadi_int eval_g_tail_n_out(void);
extern "C" casadi_int eval_g_tail_n_in(void);
extern "C" casadi_real eval_g_tail_default_in(casadi_int i);
extern "C" const char* eval_g_tail_name_in(casadi_int i);
