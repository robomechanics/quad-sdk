...
CompFilterEstimator::CompFilterEstimator(
    ...
    : StateEstimator(node, robot_ns, quadKD),
      last_mocap_time_(node->get_clock()->now()) {}

void CompFilterEstimator::init() {
  // load Comp_filter params
  quad_utils::loadROSParam(node_, "high_pass_a", high_pass_a_);
  quad_utils::loadROSParam(node_, "high_pass_b", high_pass_b_);
  quad_utils::loadROSParam(node_, "high_pass_c", high_pass_c_);
  quad_utils::loadROSParam(node_, "high_pass_d", high_pass_d_);

  quad_utils::loadROSParam(node_, "low_pass_a", low_pass_a_);
  quad_utils::loadROSParam(node_, "low_pass_b", low_pass_b_);
  quad_utils::loadROSParam(node_, "low_pass_c", low_pass_c_);
  quad_utils::loadROSParam(node_, "low_pass_d", low_pass_d_);
  high_pass_filter.A =
