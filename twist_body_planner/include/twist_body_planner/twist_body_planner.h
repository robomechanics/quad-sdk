...
/*!
   TwistBodyPlanner is a container for all of the logic utilized in the twist
   body planning node. This algorithm requires a desired twist, and will publish
   the resulting body plan as a BodyPlan message over a topic.
*/
