...
void quadNLP::loadCasadiFuncs() {
  ...
  eval_work_vec_[SIMPLE_TO_COMPLEX][JAC] = eval_jac_g_leg_simple_to_complex_work;
  eval_work_vec_[SIMPLE_TO_COMPLEX][HESS] = eval_hess_g_leg_simple_to_complex_work;
  eval_work_vec_[COMPLEX_TO_SIMPLE][FUNC] = eval_g_leg_complex_to_simple_work;
  eval_work_vec_[COMPLEX_TO_SIMPLE][JAC] = eval_jac_g_leg_complex_to_simple_work;
  eval_work_vec_[COMPLEX_TO_SIMPLE][HESS] = eval_hess_g_leg_complex_to_simple_work;
  ...
  eval_incref_vec_[SIMPLE_TO_COMPLEX][FUNC] = eval_g_leg_simple_to_complex_incref;
  eval_incref_vec_[SIMPLE_TO_COMPLEX][JAC] = eval_jac_g_leg_simple_to_complex_incref;
  eval_incref_vec_[SIMPLE_TO_COMPLEX][HESS] = eval_hess_g_leg_simple_to_complex_incref;
  eval_incref_vec_[COMPLEX_TO_SIMPLE][FUNC] = eval_g_leg_complex_to_simple_incref;
  eval_incref_vec_[COMPLEX_TO_SIMPLE][JAC] = eval_jac_g_leg_complex_to_simple_incref;
  eval_incref_vec_[COMPLEX_TO_SIMPLE][HESS] = eval_hess_g_leg_complex_to_simple_incref;
  ...
  eval_decref_vec_[SIMPLE_TO_COMPLEX][FUNC] = eval_g_leg_simple_to_complex_decref;
  eval_decref_vec_[SIMPLE_TO_COMPLEX][JAC] = eval_jac_g_leg_simple_to_complex_decref;
  eval_decref_vec_[SIMPLE_TO_COMPLEX][HESS] = eval_hess_g_leg_simple_to_complex_decref;
  eval_decref_vec_[COMPLEX_TO_SIMPLE][FUNC] = eval_g_leg_complex_to_simple_decref;
  eval_decref_vec_[COMPLEX_TO_SIMPLE][JAC] = eval_jac_g_leg_complex_to_simple_decref;
  eval_decref_vec_[COMPLEX_TO_SIMPLE][HESS] = eval_hess_g_leg_complex_to_simple_decref;
  ...
  eval_checkout_vec_[SIMPLE_TO_COMPLEX][FUNC] = eval_g_leg_simple_to_complex_checkout;
  eval_checkout_vec_[SIMPLE_TO_COMPLEX][JAC] = eval_jac_g_leg_simple_to_complex_checkout;
  eval_checkout_vec_[SIMPLE_TO_COMPLEX][HESS] = eval_hess_g_leg_simple_to_complex_checkout;
  eval_checkout_vec_[COMPLEX_TO_SIMPLE][FUNC] = eval_g_leg_complex_to_simple_checkout;
  eval_checkout_vec_[COMPLEX_TO_SIMPLE][JAC] = eval_jac_g_leg_complex_to_simple_checkout;
  eval_checkout_vec_[COMPLEX_TO_SIMPLE][HESS] = eval_hess_g_leg_complex_to_simple_checkout;
  ...
  eval_release_vec_[SIMPLE_TO_COMPLEX][FUNC] = eval_g_leg_simple_to_complex_release;
  eval_release_vec_[SIMPLE_TO_COMPLEX][JAC] = eval_jac_g_leg_simple_to_complex_release;
  eval_release_vec_[SIMPLE_TO_COMPLEX][HESS] = eval_hess_g_leg_simple_to_complex_release;
  eval_release_vec_[COMPLEX_TO_SIMPLE][FUNC] = eval_g_leg_complex_to_simple_release;
  eval_release_vec_[COMPLEX_TO_SIMPLE][JAC] = eval_jac_g_leg_complex_to_simple_release;
  eval_release_vec_[COMPLEX_TO_SIMPLE][HESS] = eval_hess_g_leg_complex_to_simple_release;
  ...
  eval_sparsity_vec_[SIMPLE_TO_COMPLEX][FUNC] = eval_g_leg_simple_to_complex_sparsity_out;
  eval_sparsity_vec_[SIMPLE_TO_COMPLEX][JAC] = eval_jac_g_leg_simple_to_complex_sparsity_out;
  eval_sparsity_vec_[SIMPLE_TO_COMPLEX][HESS] = eval_hess_g_leg_simple_to_complex_sparsity_out;
  eval_sparsity_vec_[COMPLEX_TO_SIMPLE][FUNC] = eval_g_leg_complex_to_simple_sparsity_out;
  eval_sparsity_vec_[COMPLEX_TO_SIMPLE][JAC] = eval_jac_g_leg_complex_to_simple_sparsity_out;
  eval_sparsity_vec_[COMPLEX_TO_SIMPLE][HESS] = eval_hess_g_leg_complex_to_simple_sparsity_out;
  ...
  first_step_idx_mat_.resize(num_sys_id_, num_func_id_);
